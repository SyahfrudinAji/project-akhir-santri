  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form action="proses/author_proses_tambah.php" method="post" class="form-horizontal" id="form">
              <!-- <div class="box-body"> -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input name="email" type="email" class="form-control required" placeholder="Alamat Email">
                </div>
              </div>
              <div class="form-group">
